...
var area_la_cruz = ee.FeatureCollection('projects/eddycc66/assets/area_la_cruz');
var geometry = area_la_cruz.geometry();

// Verificar el área cargada
print('Área de estudio cargada:', area_la_cruz);
print('Número de polígonos:', area_la_cruz.size());

// Visualizar el área
Map.centerObject(geometry, 12);
Map.addLayer(area_la_cruz, {color: 'FF0000'}, 'Área La Cruz');
